...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "Onboarding quiz + BMI calc", included: true },
      { text: "AI food photo scanner", included: false },
      { text: "Personalized meal plans", included: false },
      { text: "Auto-generated workout plans", included: false },
      { text: "Unlimited workout regimes", included: false },
      { text: "Smartwatch integration", included: false },
      ...
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        <div className="flex flex-col gap-4 mb-8">
          {PLANS.map(plan => (
            <div
              key={plan.name}
              className={`rounded-2xl border p-5 ${plan.highlight ? "bg-amber-500/5 border-amber-500/30 ring-1 ring-amber-500/20" : "bg-[#141414] border-neutral-800"}`}
            >
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <FAQ q="How does AI food scanner work?" a="Take a photo of your meal. Our AI (GPT-4o Vision) identifies every item and estimates macros instantly." />
            <FAQ q="When is smartwatch coming?" a="We're working on Apple Watch & Garmin integrations. Coming Q3 2026." />
          </div>
        </div>
      </div>
      <Nav />
